...
if( !empty($phno) && !empty($date)  && !empty($time)){	
		...
		$query="insert into clockin values('$phno','$date','$time')";
...
<center><h1>Staff Clock-In</h1></center>
...
<tr>
<td></td>
<td><input type="submit" name="submit"  value="CLOCK IN" maxlength="50"required /></td>
</tr>
</center></table>
</form>
